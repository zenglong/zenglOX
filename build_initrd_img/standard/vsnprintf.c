// please see http://www.castaglia.org/proftpd/doc/devel-guide/src/lib/vsnprintf.c.html

#include <stdlib.h>

#define HAVE_FCVT
#define HAVE_FLOATINGPOINT_H
...
#  elif defined(HAVE_FCVT)
		...
		//cbp = cvtbuf;
		cbp = (char *)fcvtbuf(dval, ndigit, &decpt, &sign, (char *)cvtbuf);
#  endif
